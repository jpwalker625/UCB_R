...
And then I will create a model to predict the likelihood of using my phone.
...
lmo <- lm(formula = length_in_minutes ~ time_of_day + weekdays, data = pickups)

pickups %>% data_grid(time_of_day, weekdays) %>% add_predictions(lmo)
